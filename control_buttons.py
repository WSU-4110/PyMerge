...
class ControlButtons(QWidget):
    ...
    def button_layout(self):
        ...
        import_file1_button.clicked.connect(main_window.MainWindow.import_file1)
        ...
        merge_button.clicked.connect(main_window.MainWindow.merge_files)
        ...
        import_file2_button.clicked.connect(main_window.MainWindow.import_file2)
